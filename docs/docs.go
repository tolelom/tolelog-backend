            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.PostListWithPagination"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/posts/{id}": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Bearer token (비공개 글 조회 시 필요)",
                        "name": "Authorization",
                        "in": "header"
                    }
                ],
        ...
        "/posts/{id}/like": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Bearer token (로그인 시)",
                        "name": "Authorization",
                        "in": "header"
                    }
                ],
        ...
        "/series/{id}/posts": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "추가할 글 정보",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.AddPostToSeriesRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/series/{id}/reorder": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "새로운 글 순서",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.ReorderPostsRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/tags": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "정렬 기준: popular(기본) 또는 name",
                        "name": "sort",
                        "in": "query"
                    },
                    {
